 ...
 */
var walkingChallenges = ["Walk for 5 minutes", "Walk 3 miles a day"]
var runningChallenges = ["Run 5 times a week", "Run 3.1 miles"]
...
let firstlist = challenges[0]
let firstChallenge = challenges[0][0]

print(firstlist)
print(firstChallenge)
...
var commitedChallenges: [String] = ["have a good day"]
