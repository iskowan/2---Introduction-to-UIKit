 ...
 */
let walkingChallenges = ["Walk 2 miles", "Walk for 5 minutes"]
let runningChallenges = ["Run for 4 minutes", "Run 3 miles"]
...
var commitedChallenges: [String] = ["Walk 5 minutes"]
...
if commitedChallenges.isEmpty{
    ...
    print("You have commited to mulitple challenges")
}
