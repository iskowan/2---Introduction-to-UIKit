 ...
 */
var daysOfMonth: [String: Int] = ["January": 31, "Febuary": 28, "March": 31]
print(daysOfMonth)
...
daysOfMonth.updateValue(29, forKey: "Febuary")
print(daysOfMonth)

//:  Use if-let syntax to retrieve the number of days under "January." If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if let janValue = daysOfMonth["January"]{
    print("January has \(daysOfMonth["January"]) days")
} else {
    print("I could not find a value in janValue")
}
